import CryptoJS from './crypyo'
import Util from './wxUtil'
...
;(function ($, window, document) {
    ...
    //请求图片get事件
    function getPictrue(userid,data, baseUrl, resolve, reject) {
        $.ajax({
            type: "post",
    ...
    //验证图片check事件
    function checkPictrue(userid,data, baseUrl, resolve, reject) {
        $.ajax({
            type: "post",
            contentType: "application/json;charset=UTF-8",
    ...
    Slide.prototype = {
        ...
        //鼠标松开
            ...
            if (this.status && this.isEnd == false) {
                ...
                checkPictrue(userid,data, this.options.baseUrl, function (res) {
                    // 请求反正成功的判断
                    if (res.repCode == "0000") {
            ...
            _this.$element.find('.back-img').on('click', function (e) {
                ...
                if (_this.num == _this.options.checkNum) {
                    ...
                    setTimeout(function () {
                        ...
                        checkPictrue(userid,data, _this.options.baseUrl, function (res) {
                            if (res.repCode == "0000") {
